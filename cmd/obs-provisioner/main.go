...
var (
	provisioner = flag.String("provisioner", "external.k8s.io/obs", "Name of the provisioner. The provisioner will only provision volumes for claims that request a StorageClass with a provisioner field set equal to this name.")
...
func main() {
	...
	glog.Infof("Get informations. server version: %s", serverVersion.GitVersion)

	provisionController := controller.NewProvisionController(
		clientset,
		*provisioner,
		obs.NewProvisioner(clientset, cc),
